<?php
  ...
  if($con==false){
    ...
    if(isset($_POST['submit'])){
      if($_POST['t1'] != '' and ($_POST['t2'] != '' or $_POST['t3'] != 'Year' or ($_POST['t3'] != 'Year' and $_POST['t4'] != 'Month'))){
      $air=$_SESSION["temp"];
      $ser=$_POST['t1'];
      $dat=$_POST['t2'];
      $year=$_POST['t3'];
      ...
      elseif(strlen($year)==4){
        if(strlen($month)==2){
          ...
          foreach( $months as $a){
            $t=$year."-".$a;
            $q="SELECT count(substr(Entry,1,10)) FROM $air where Trolly=1 AND substr(Entry,1,7)='$t' GROUP BY substr(Entry,1,10) ORDER BY count(substr(Entry,1,10)) DESC";
            $res=mysqli_query($con,$q);
            $temp1=mysqli_fetch_array($res);
            $r=$temp1[0] ?? NULL;
...
<html>
    ...
    <body>
        ...
        <table class="display" style="margin-left: 10px" cellspacing="40">
          <tr height="500px">
          <td align="center"  >
          <form style="font-size: 30px" Id="f1" action="Display1.php" method="post">
            <h1>Welcome to <?php echo strtoupper($_SESSION["temp"]);?> Dashboard</h1>
            <br>
            ...
            <select name="t3" style = "font-size : 27px">
              <option>Year</option>
        ...
        <td>
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <?php
        if(isset($_POST['submit']) and $_POST['t1'] != '' and ($_POST['t2'] != '' or $_POST['t3'] != 'Year' or ($_POST['t3'] != 'Year' and $_POST['t4'] != 'Month'))){
        echo "
           <div id='display'></div>
            <script>
